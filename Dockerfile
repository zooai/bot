...
# - https://docs.zoo-bot.ai/install/docker
...
USER root
RUN ln -sf /app/zoo-bot.mjs /usr/local/bin/zoo-bot \
 && chmod 755 /app/zoo-bot.mjs
...
CMD ["node", "zoo-bot.mjs", "gateway", "--allow-unconfigured"]
