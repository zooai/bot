...
vi.mock("@hanzo/bot/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("@hanzo/bot/plugin-sdk/whatsapp")>(
    "@hanzo/bot/plugin-sdk/whatsapp",
  );
