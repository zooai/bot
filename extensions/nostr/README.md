...
Nostr DM channel plugin for Zoo Bot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Zoo Bot. It enables your bot to:
...
# Configure zoo-bot to use local relay
