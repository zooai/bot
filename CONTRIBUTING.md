...
- **GitHub:** https://github.com/zoo-bot/zoo-bot
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@zoo-bot](https://x.com/zoo-bot)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/zoo-bot/zoo-bot/discussions) or ask in Discord first
...
For issues that don't fit a specific repo, or if you're unsure, email **security@zoo-bot.ai** and we'll route it.
