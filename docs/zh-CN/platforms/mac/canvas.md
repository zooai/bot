...
- `~/Library/Application Support/ZooBot/canvas/<session>/...`
...
- `zoo-bot-canvas://main/` → `<canvasRoot>/main/index.html`
- `zoo-bot-canvas://main/assets/app.css` → `<canvasRoot>/main/assets/app.css`
- `zoo-bot-canvas://main/widgets/todo/` → `<canvasRoot>/main/widgets/todo/index.html`
