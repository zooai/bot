...
> **📦 完整指南：[github.com/zoo-bot/nix-zoo-bot](https://github.com/zoo-bot/nix-zoo-bot)**
>
> nix-zoo-bot 仓库是 Nix 安装的权威来源。本页只是一个快速概述。
...
```bash
defaults write bot.molt.mac zoo-bot.nixMode -bool true
```
...
- [nix-zoo-bot](https://github.com/zoo-bot/nix-zoo-bot) — 完整设置指南
