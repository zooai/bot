...
When a site requires login, **sign in manually** in the **host** browser profile (the zoo-bot browser).
...
zoo-bot browser open https://x.com
```

If you have multiple profiles, pass `--browser-profile <name>` (the default is `zoo-bot`).
...
```bash
zoo-bot browser open https://x.com --browser-profile zoo-bot --target host
```
