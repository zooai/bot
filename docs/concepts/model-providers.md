...
- CLI helpers: `zoo-bot onboard`, `zoo-bot models list`, `zoo-bot models set <provider/model>`.
...
- CLI: `zoo-bot onboard --auth-choice openai-api-key`
...
- CLI: `zoo-bot onboard --auth-choice token` (paste setup-token) or `zoo-bot models auth paste-token --provider anthropic`
...
- CLI: `zoo-bot onboard --auth-choice opencode-zen`
...
- CLI: `zoo-bot onboard --auth-choice gemini-api-key`
...
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  - Enable: `zoo-bot plugins enable google-gemini-cli-auth`
  - Login: `zoo-bot models auth login --provider google-gemini-cli --set-default`
  - Note: you do **not** paste a client id or secret into `zoo-bot.json`. The CLI login flow stores
...
- CLI: `zoo-bot onboard --auth-choice zai-api-key`
...
- CLI: `zoo-bot onboard --auth-choice ai-gateway-api-key`
...
- CLI: `zoo-bot onboard --kilocode-api-key <key>`
...
- CLI: `zoo-bot onboard --auth-choice mistral-api-key`
- Groq: `groq` (`GROQ_API_KEY`)
- Cerebras: `cerebras` (`CEREBRAS_API_KEY`)
  - GLM models on Cerebras use ids `zai-glm-4.7` and `zai-glm-4.6`.
  - OpenAI-compatible base URL: `https://api.cerebras.ai/v1`.
- GitHub Copilot: `github-copilot` (`COPILOT_GITHUB_TOKEN` / `GH_TOKEN` / `GITHUB_TOKEN`)
- Hugging Face Inference: `huggingface` (`HUGGINGFACE_HUB_TOKEN` or `HF_TOKEN`) — OpenAI-compatible router; example model: `huggingface/deepseek-ai/DeepSeek-R1`; CLI: `zoo-bot onboard --auth-choice huggingface-api-key`. See [Hugging Face (Inference)](/providers/huggingface).
...
- CLI: `zoo-bot onboard --auth-choice volcengine-api-key`
...
- CLI: `zoo-bot onboard --auth-choice byteplus-api-key`
...
- CLI: `zoo-bot onboard --auth-choice synthetic-api-key`
...
```bash
zoo-bot onboard --auth-choice opencode-zen
zoo-bot models set opencode/claude-opus-4-6
zoo-bot models list
```
