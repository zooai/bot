...
EOF
sudo install -m 644 -o root -g wheel /tmp/ai.zoo.bot.plist /Library/Preferences/Logging/Subsystems/ai.zoo.bot.plist
```
...
- Remove the override: `sudo rm /Library/Preferences/Logging/Subsystems/ai.zoo.bot.plist`.
