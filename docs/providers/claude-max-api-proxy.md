...
You can point ZooBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ZooBot
...
- [Anthropic provider](/providers/anthropic) - Native ZooBot integration with Claude setup-token or API keys
