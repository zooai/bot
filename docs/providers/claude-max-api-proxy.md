...
You can point Bot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Bot
...
- [Anthropic provider](/providers/anthropic) - Native Bot integration with Claude setup-token or API keys
