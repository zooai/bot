...
under `~/.zoo-bot/hooks/transforms` (see [Webhooks](/automation/webhook)).
...
```bash
gog gmail watch status --account zoo-bot@gmail.com
gog gmail history --account zoo-bot@gmail.com --since <historyId>
```
...
```bash
gog gmail watch stop --account zoo-bot@gmail.com
