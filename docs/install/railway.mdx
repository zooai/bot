...
Deploy ZooBot on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/zoo-bot` — Control UI
...
- `BOT_STATE_DIR=/data/.zoo-bot` (recommended)
...
This exports your ZooBot state + workspace so you can migrate to another host without losing config or memory.
