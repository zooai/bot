...
```bash
mkdir -p /root/.zoo-bot/workspace

# Set ownership to the container user (uid 1000):
chown -R 1000:1000 /root/.zoo-bot
```
...
BOT_CONFIG_DIR=/root/.zoo-bot
BOT_WORKSPACE_DIR=/root/.zoo-bot/workspace
...
- Infrastructure: [zoo-bot-terraform-hetzner](https://github.com/andreesg/zoo-bot-terraform-hetzner)
- Docker config: [zoo-bot-docker-config](https://github.com/andreesg/zoo-bot-docker-config)
