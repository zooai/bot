...
read_when:
  - You want to understand `zoo-bot.ai/install.sh`
...
<Tabs>
  <Tab title="install.sh">
    ...
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install.sh | bash -s -- --help
    ```

  </Tab>
  <Tab title="install-cli.sh">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install-cli.sh | bash
    ```

    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install-cli.sh | bash -s -- --help
    ```

  </Tab>
  <Tab title="install.ps1">
    ```powershell
    iwr -useb https://zoo-bot.ai/install.ps1 | iex
    ```

    ```powershell
    & ([scriptblock]::Create((iwr -useb https://zoo-bot.ai/install.ps1))) -Tag beta -NoOnboard -DryRun
    ```
...
<Note>
If install succeeds but `zoo-bot` is not found in a new terminal, see [Node.js troubleshooting](/install/node#troubleshooting).
</Note>
...
<Steps>
  ...
  <Step title="Post-install tasks">
    - Runs `zoo-bot doctor --non-interactive` on upgrades and git installs (best effort)
...
<Tabs>
  ...
  <Tab title="Dry run">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install.sh | bash -s -- --dry-run
    ```
  </Tab>
</Tabs>
...
<Info>
Designed for environments where you want everything under a local prefix (default `~/.zoo-bot`) and no system Node dependency.
</Info>
...
<Tabs>
  ...
  <Tab title="Custom prefix + version">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install-cli.sh | bash -s -- --prefix /opt/zoo-bot --version latest
    ```
  </Tab>
  <Tab title="Automation JSON output">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install-cli.sh | bash -s -- --json --prefix /opt/zoo-bot
    ```
  </Tab>
  <Tab title="Run onboarding">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install-cli.sh | bash -s -- --onboard
    ```
  </Tab>
</Tabs>
...
<Steps>
  ...
  <Step title="Post-install tasks">
    Adds needed bin directory to user PATH when possible, then runs `zoo-bot doctor --non-interactive` on upgrades and git installs (best effort).
  </Step>
</Steps>
...
<Tabs>
  ...
  <Tab title="Git install">
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://zoo-bot.ai/install.ps1))) -InstallMethod git
    ```
  </Tab>
  <Tab title="Custom git directory">
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://zoo-bot.ai/install.ps1))) -InstallMethod git -GitDir "C:\zoo-bot"
    ```
  </Tab>
  <Tab title="Dry run">
    ```powershell
    & ([scriptblock]::Create((iwr -useb https://zoo-bot.ai/install.ps1))) -DryRun
    ```
  </Tab>
...
<Tabs>
  <Tab title="install.sh (non-interactive npm)">
    ```bash
    curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install.sh | bash -s -- --no-prompt --no-onboard
    ```
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="sharp/libvips issues">
    ...
    ```bash
    SHARP_IGNORE_GLOBAL_LIBVIPS=0 curl -fsSL --proto '=https' --tlsv1.2 https://zoo-bot.ai/install.sh | bash
    ```
  ...
  <Accordion title='Windows: "zoo-bot is not recognized"'>
  ...
  <Accordion title="zoo-bot not found after install">
