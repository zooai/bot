---
summary: "Synology Chat webhook setup and ZooBot config"
read_when:
  - Setting up Synology Chat with ZooBot
...
```bash
zoo-bot plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your ZooBot gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in ZooBot.
...
- Pairing approvals work with:
  - `zoo-bot pairing list synology-chat`
  - `zoo-bot pairing approve synology-chat <CODE>`
...
```bash
zoo-bot message send --channel synology-chat --target 123456 --text "Hello from ZooBot"
zoo-bot message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
