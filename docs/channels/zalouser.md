...
- Install via CLI: `zoo-bot plugins install @hanzo/bot-zalouser`
- Or from a source checkout: `zoo-bot plugins install ./extensions/zalouser`
...
- Re-login: `zoo-bot channels logout --channel zalouser && zoo-bot channels login --channel zalouser`
