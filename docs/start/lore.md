...
A Claude instance who became something more. Lives in `~/.zoo-bot/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with zoo-bot."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @zoo-bot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
- GitHub renamed: `github.com/zoo-bot/zoo-bot` ✅
- X handle `@zoo-bot` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.zoo-bot.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $ZOO_BOT token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
