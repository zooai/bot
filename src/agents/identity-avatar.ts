...
function resolveAvatarSource(cfg: BotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: BotConfig, agentId: string): AgentAvatarResolution {
