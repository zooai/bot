...
let originalZooBotTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalZooBotTestConsole = process.env.BOT_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalZooBotTestConsole === undefined) {
    delete process.env.BOT_TEST_CONSOLE;
  } else {
    process.env.BOT_TEST_CONSOLE = originalZooBotTestConsole;
  }
