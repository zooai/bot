...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: BotConfig): boolean {
...
export function summarizeBindings(cfg: BotConfig, bindings: AgentBinding[]): string[] {
