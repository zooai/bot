...
import ai.zoo.bot.android.ui.mobileSurface
import ai.zoo.bot.android.ui.mobileText
import ai.zoo.bot.android.ui.mobileTextSecondary
import ai.zoo.bot.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.zoo.bot.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.zoo.bot.android.ui.mobileFontFamily,
