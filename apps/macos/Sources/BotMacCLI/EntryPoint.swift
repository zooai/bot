...
struct BotMacCLI {
    static func main() async {
        ...
        default:
            fputs("hanzo-bot-mac: unknown command\n", stderr)
            printUsage()
            exit(1)
        }
    }
...
private func printUsage() {
    ...
    Examples:
      ...
      hanzo-bot-mac connect --url ws://127.0.0.1:18789 --json
      hanzo-bot-mac discover --timeout 3000 --json
      hanzo-bot-mac wizard --mode local
    """)
}
