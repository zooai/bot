...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .hanzo-botSelectSettingsTab)) { note in
...
extension Notification.Name {
    static let hanzo-botSelectSettingsTab = Notification.Name("hanzo-botSelectSettingsTab")
}
