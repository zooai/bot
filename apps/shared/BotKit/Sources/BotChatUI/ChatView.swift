...
@MainActor
public struct HanzoBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: HanzoBotChatViewModel,
    ...
    private var visibleMessages: [HanzoBotChatMessage] {
        let base: [HanzoBotChatMessage]
    ...
    private func mergeToolResults(in messages: [HanzoBotChatMessage]) -> [HanzoBotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = HanzoBotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: HanzoBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: HanzoBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: HanzoBotChatMessage) -> String {
