...
public typealias HanzoBotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias HanzoBotPlatformImage = UIImage
#endif

public struct HanzoBotChatUsageCost: Codable, Hashable, Sendable {
...
public struct HanzoBotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: HanzoBotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(HanzoBotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct HanzoBotChatMessageContent: Codable, Hashable, Sendable {
...
public struct HanzoBotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [HanzoBotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: HanzoBotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [HanzoBotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: HanzoBotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(HanzoBotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([HanzoBotChatMessageContent].self, forKey: .content) {
...
public struct HanzoBotChatHistoryPayload: Codable, Sendable {
...
public struct HanzoBotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct HanzoBotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [HanzoBotSessionPreviewItem]
}

public struct HanzoBotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [HanzoBotSessionPreviewEntry]

    public init(ts: Int, previews: [HanzoBotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct HanzoBotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct HanzoBotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct HanzoBotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct HanzoBotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct HanzoBotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct HanzoBotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: HanzoBotPlatformImage?
...
public struct HanzoBotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
